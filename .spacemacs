  ...
  (with-eval-after-load 'counsel
    (setq counsel-rg-base-command
          '("rg"
            ...
            "--color" "never"
            "--hidden"
            "--no-ignore" ; Отключает игнорирование по .gitignore и .ignore
            "--glob" "!.git"  ; Игнорировать .git директорию
            "--glob" "!*.tmp" ; Игнорировать временные файлы
            "--glob" "!.*"    ; Игнорировать скрытые файлы
            "--glob" "!.#*"   ; Игнорировать файлы, начинающиеся с .
            "%s")))
